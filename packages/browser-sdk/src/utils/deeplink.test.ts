import { getDeeplinkToLiquid } from "./deeplink";

describe("getDeeplinkToLiquid", () => {
  ...
  it("builds a deeplink for the current URL without ref", () => {
    ...
    const result = getDeeplinkToLiquid();
  ...
  it("includes an encoded ref param when provided", () => {
    ...
    const result = getDeeplinkToLiquid("my ref");
  ...
  it("throws for non-http(s) URLs", () => {
    expect(() => getDeeplinkToLiquid(undefined, "chrome-extension://abcdef/index.html")).toThrow(
