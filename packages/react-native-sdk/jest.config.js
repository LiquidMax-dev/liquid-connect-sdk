module.exports = {
  ...
  moduleNameMapper: {
    ...
    "^@/(.*)$": "<rootDir>/src/$1",
    "^@liquid/crypto$": "<rootDir>/src/test/mocks/@liquid/crypto.js",
    "^@liquid/base64url$": "<rootDir>/src/test/mocks/@liquid/base64url.js",
    "^@liquid/wallet-sdk-ui$": "<rootDir>/../ui/src/index.ts",
  ...
  transformIgnorePatterns: ["node_modules/(?!(react-native|@react-native|expo-.*|@liquid)/)"],
};
