    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-50">
      <main className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 space-y-6">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Liquid SDK + Next.js</h1>
          <p className="text-gray-600">Connect your Liquid wallet and sign a message</p>
      ...
      <footer className="mt-8 text-center text-gray-500">
        ...
        <p className="text-xs mt-2">Built with Liquid React SDK - demonstrating SSR compatibility</p>
